...
import { signupInput } from "@ahamed_ajas/common";
        ...
        <div>
         <div className="px-10">
          ...
          <div className="text-slate-400">
            ...
            <Link className="pt-2 underline" to={type === "signin"? "/signup" : "/signin"}> {type === "signin" ? "signup" : "signin"}</Link>
          </div>
        </div>
        <div className="pt-8">
            {type  === "signup" ?<LabelledInput
            label="Name" placeholder="Ahamed Ajas..." onChange={(e) => {
              setPostInputs({
                ...postInputs,
                name: e.target.value
              });
          ...
          /> : null}
          <LabelledInput
            label="Username" placeholder="ajas.greenrose@gmail.com" onChange={(e) => {
              setPostInputs({
                ...postInputs,
          ...
          />
          <LabelledInput
            label="Password" type="password" placeholder="12345" onChange={(e) => {
              setPostInputs({
                ...postInputs,
